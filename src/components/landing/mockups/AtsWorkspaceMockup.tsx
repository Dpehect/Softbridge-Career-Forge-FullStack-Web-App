...
export function AtsWorkspaceMockup() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-3xl">
      <div className="landing-mock-strong overflow-hidden">
        ...
        <div className="grid gap-3 p-4 sm:grid-cols-[0.9fr_1.1fr] sm:p-5">
          <div className="rounded-xl border border-[var(--ld-border)] bg-[var(--ld-bg)] p-4">
            <p className="text-xs font-bold uppercase tracking-[0.12em] text-[var(--ld-ink-2)]">
              Özgeçmiş önizleme
            </p>
            <p className="mt-3 text-sm font-bold text-[var(--ld-ink)]">Ayşe Demir</p>
            <p className="mt-0.5 text-sm font-semibold text-[var(--ld-teal)]">Senior Frontend Engineer</p>
            ...
            <div className="mt-4 rounded-lg border border-[var(--ld-border)] bg-[var(--ld-surface)] p-2.5">
              <p className="text-xs font-bold text-[var(--ld-ink-2)]">Deneyim</p>
              <p className="mt-1 text-xs leading-5 text-[var(--ld-ink)]">
          ...
          <div className="space-y-3">
            <div className="rounded-xl border border-[var(--ld-border)] bg-[var(--ld-surface)] p-4">
              <p className="text-xs font-bold uppercase tracking-[0.1em] text-[var(--ld-teal)]">
                ATS skoru
              </p>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                >
                  <p className="text-xs font-semibold text-[var(--ld-ink-2)]">{label}</p>
                  <p className="mt-0.5 text-sm font-bold text-[var(--ld-ink)]">{score}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      >
        <p className="text-xs font-bold uppercase tracking-wider text-[var(--ld-ink-2)]">
          Öneri
        </p>
      ...
      >
        <p className="text-xs font-bold uppercase tracking-wider text-[var(--ld-teal)]">
          Anahtar kelimeler
        </p>
        <div className="mt-2 flex flex-wrap gap-1">
          {["React", "TypeScript", "ATS"].map((t) => (
            <span
              key={t}
              className="rounded-full bg-[var(--ld-mint)] px-2.5 py-1 text-xs font-bold text-[var(--ld-teal-deep)]"
            >
              {t}
            </span>
          ))}

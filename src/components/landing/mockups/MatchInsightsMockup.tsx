  ...
  return (
    <div className="landing-mock-strong overflow-hidden p-4 sm:p-5">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.1em] text-[var(--ld-ink-2)]">
            Rol eşleştirme
          </p>
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="rounded-xl border border-[var(--ld-border)] bg-[var(--ld-bg)] p-3">
          ...
          <ul className="mt-2 space-y-2 text-sm font-semibold text-[var(--ld-ink)]">
        ...
        <div className="rounded-xl border border-[var(--ld-border)] bg-[var(--ld-bg)] p-3">
          <p className="text-xs font-bold uppercase tracking-wider text-[#7a460b]">
            Eksik sinyaller
          </p>
          <ul className="mt-2 space-y-2 text-sm font-semibold text-[var(--ld-ink)]">
      ...
      <div className="mt-3 rounded-xl border border-[var(--ld-border)] p-3">
        ...
        <div className="mt-3 flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-[var(--ld-ink-2)]">Mülakat hazırlığı %70</span>
        </div>
      </div>
    </div>
  );

...
export default function ForgePage() {
  ...
  const copy = locale === "tr" ? {
    ...
    backup: "Yerel yedek oluştur", backupReady: "Yerel yedek oluşturuldu.", backupEmpty: "Yedek oluşturmak için önce CV ekleyin.", backups: "CV yedekleri", activity: "Analiz geçmişi", noBackup: "Henüz yerel yedek yok.", noHistory: "Henüz analiz geçmişi yok.", restore: "Geri yükle", restored: "Yedek geri yüklendi.", delete: "Yedeği sil", sample: "Demo veri", privacy: "CV içeriği standart analiz sırasında sunucuya gönderilmez. Harici AI kullanımı eklenirse işlem öncesinde ayrıca açıklanmalıdır.",
  } : {
    ...
    backup: "Create local backup", backupReady: "Local backup created.", backupEmpty: "Add a resume before creating a backup.", backups: "Resume backups", activity: "Analysis history", noBackup: "No local backups yet.", noHistory: "No analysis history yet.", restore: "Restore", restored: "Backup restored.", delete: "Delete backup", sample: "Demo data", privacy: "Resume content is not sent to a server during standard analysis. Any external AI use must be disclosed before processing.",
  };
